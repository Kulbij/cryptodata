    ...
    return [
        ...
        'components' => [
            ...
            'shared' => [
                ...
                'is_custom_contact_form'      => ['title' => 'Custom contact form' , 'description' => 'Individual contact form, with a separate logic for sending emails'],
                ...
                'mail_recipients_by_type'   => ['title' => 'Recipients by topic Partnership'         , 'description' => 'Specify email recipients (add one address per line)'],
                'mail_bcc'          => ['title' => 'BCC'                , 'description' => 'Send blind carbon copy to email recipients (add one address per line)'],
                'mail_cc'          => ['title' => 'CC'                , 'description' => 'Send blind carbon copy to email recipients (add one address per line)'],
